export LD_LIBRARY_PATH=`pwd`/src/libcw/.libs  && gdb --args ./src/libcw/tests/.libs/libcw_tests -N test_cw_gen_forever_internal -S p -t 300 -X plughw

./tests/libcw_tests  -S a  -X plughw -N legacy_api_test_cw_queue_tone
clicks


---------------
No reproduction
./src/libcw/tests/libcw_tests -S a -X plughw -A k --random-seed 1601917967

Reproduction
./src/libcw/tests/libcw_tests -S a -X plughw -A k --random-seed 1601917893
---------------
...
export LD_LIBRARY_PATH=`pwd`/src/libcw/.libs  && gdb --args ./src/libcw/tests/.libs/libcw_tests -A r -S a -X plughw
